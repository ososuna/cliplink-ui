...
const $$ShortUrlCard = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Card", Card, { "className": "w-full max-w-md mx-auto" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "CardHeader", CardHeader, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "CardTitle", CardTitle, {}, { "default": ($$result4) => renderTemplate`URL Shortener` })} ${renderComponent($$result3, "CardDescription", CardDescription, {}, { "default": ($$result4) => renderTemplate`Shortened version of your long URL.` })} ` })} ${renderComponent($$result2, "CardContent", CardContent, {}, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="grid w-full items-center gap-4"> <div class="flex flex-col space-y-1.5"> ${renderComponent($$result3, "Label", Label, { "htmlFor": "longUrl" }, { "default": ($$result4) => renderTemplate`Short URL` })} ${renderComponent($$result3, "CopyInput", CopyInput, { "value": `https://example.com/${id}}` })} </div> </div> ` })} ${renderComponent($$result2, "CardFooter", CardFooter, {}, { "default": ($$result3) => renderTemplate` <div class="flex space-x-4"> ${renderComponent($$result3, "Button", Button, { "type": "button" }, { "default": ($$result4) => renderTemplate` ${renderComponent($$result4, "ExternalLink", ExternalLink, {})} Open Short URL
